...
if PHOTOS
  Photo.create!([
    ...
    {:id=>105,:image_file_name=>'10005.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'528438',:image_updated_at=>Time.now,:title=>"Beginn",           :description=>"Der erste Gast",               :album_id=>102,:user_id=>101,:private=>false,:created_at=>Time.now,:updated_at=>Time.now},
    {:id=>106,:image_file_name=>'10006.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'621534',:image_updated_at=>Time.now,:title=>"Stimmung",         :description=>"Alle tanzen",                  :album_id=>102,:user_id=>101,:private=>false,:created_at=>Time.now,:updated_at=>Time.now},
    {:id=>107,:image_file_name=>'10007.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'548163',:image_updated_at=>Time.now,:title=>"Hund",             :description=>"Ein Hund im Park",             :album_id=>103,:user_id=>101,:private=>true, :created_at=>Time.now,:updated_at=>Time.now},
    {:id=>108,:image_file_name=>'10008.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'570948',:image_updated_at=>Time.now,:title=>"Auto",             :description=>"Ein parkendes Auto",           :album_id=>103,:user_id=>101,:private=>false,:created_at=>Time.now,:updated_at=>Time.now},
    {:id=>109,:image_file_name=>'10009.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'581258',:image_updated_at=>Time.now,:title=>"Ball",             :description=>"Cooler Ball",                  :album_id=>103,:user_id=>101,:private=>false,:created_at=>Time.now,:updated_at=>Time.now},
    {:id=>110,:image_file_name=>'10002.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'453342',:image_updated_at=>Time.now,:title=>"Sonnenuntergang",  :description=>"Der Sonnenuntergang am Strand",:album_id=>101,:user_id=>101,:private=>false,:created_at=>Time.now,:updated_at=>Time.now},
    {:id=>111,:image_file_name=>'10003.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'479609',:image_updated_at=>Time.now,:title=>"Fische",           :description=>"Kleine Fische im Wasser",      :album_id=>101,:user_id=>101,:private=>false,:created_at=>Time.now,:updated_at=>Time.now},
    {:id=>112,:image_file_name=>'10004.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'480515',:image_updated_at=>Time.now,:title=>"Partyvorbereitung",:description=>"Foto vom Aufbauen",            :album_id=>102,:user_id=>101,:private=>true, :created_at=>Time.now,:updated_at=>Time.now},
    {:id=>113,:image_file_name=>'10005.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'528438',:image_updated_at=>Time.now,:title=>"Beginn",           :description=>"Der erste Gast",               :album_id=>102,:user_id=>101,:private=>false,:created_at=>Time.now,:updated_at=>Time.now},
    {:id=>114,:image_file_name=>'10006.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'621534',:image_updated_at=>Time.now,:title=>"Stimmung",         :description=>"Alle tanzen",                  :album_id=>102,:user_id=>101,:private=>false,:created_at=>Time.now,:updated_at=>Time.now},
    {:id=>115,:image_file_name=>'10007.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'548163',:image_updated_at=>Time.now,:title=>"Hund",             :description=>"Ein Hund im Park",             :album_id=>103,:user_id=>101,:private=>true, :created_at=>Time.now,:updated_at=>Time.now},
    {:id=>116,:image_file_name=>'10008.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'570948',:image_updated_at=>Time.now,:title=>"Auto",             :description=>"Ein parkendes Auto",           :album_id=>103,:user_id=>101,:private=>false,:created_at=>Time.now,:updated_at=>Time.now},
    {:id=>117,:image_file_name=>'10009.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'581258',:image_updated_at=>Time.now,:title=>"Ball",             :description=>"Cooler Ball",                  :album_id=>103,:user_id=>101,:private=>false,:created_at=>Time.now,:updated_at=>Time.now}
  ])
end
