...
if PHOTOS
  Photo.create!([
    {:id=>101,:image_file_name=>'10001.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'406387',:image_updated_at=>Time.now,:title=>"Strand",           :description=>"Der Strand im Urlaub",         :album_id=>101,:user_id=>101,:private=>false,:created_at=>Time.now,:updated_at=>Time.now},
    ...
    {:id=>104,:image_file_name=>'10004.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'480515',:image_updated_at=>Time.now,:title=>"Partyvorbereitung",:description=>"Foto vom Aufbauen",            :album_id=>102,:user_id=>101,:private=>false,:created_at=>Time.now,:updated_at=>Time.now},
    ...
    {:id=>107,:image_file_name=>'10007.jpg',:image_content_type=>'image/jpeg',:image_file_size=>'548163',:image_updated_at=>Time.now,:title=>"Hund",             :description=>"Ein Hund im Park",             :album_id=>103,:user_id=>101,:private=>false,:created_at=>Time.now,:updated_at=>Time.now},
