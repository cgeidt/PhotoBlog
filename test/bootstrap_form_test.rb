...
class BootstrapFormTest < ActionView::TestCase
  ...
  test "bootstrap_form_tag acts like a form tag" do
    ...
    assert_equal expected, bootstrap_form_tag(image: '/users') { |f| f.text_field :email, label: "Your Email" }
  end
  ...
  test "bootstrap_form_tag does not clobber custom options" do
    ...
    assert_equal expected, bootstrap_form_tag(image: '/users') { |f| f.text_field :email, name: 'NAME', id: "ID" }
  end
